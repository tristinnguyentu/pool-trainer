...
export const SHOTS: ShotDef[] = [
  ...
  // ============================================================
  {
    ...
    tips: [
      ...
      'Classic miss: pros call this "wobble" — an unlevel cue or a slightly off-center hit imparts ' +
        'accidental spin, sending the cue ball creeping forward or back instead of stopping.',
      'Use firm, even speed — stop shots actually work better a bit faster; too soft and any tiny ' +
        'spin error is exaggerated.',
    ],
    balls: [
  ...
  },
  {
    ...
    description:
      ...
      'line after the collision — essential for staying with your next shot instead of leaving the ' +
      'table.',
    tips: [
  ...
  },
  {
    ...
    description:
      ...
      'in the game — learn to control how FAR it comes back with speed, not just spin.',
    tips: [
      ...
      'Strike low (sy ≈ -0.6), keep the cue level, and follow through — decelerating into the ball is ' +
        'the #1 cause of a whiffed or weak draw.',
  ...
  // ============================================================
  {
    ...
    tips: [
      ...
      'At this shallow an angle you are hitting fairly full (fullness = 1 − sin(cut) ≈ 0.74, roughly a ' +
        'three-quarter-ball hit); classic miss is over-cutting because the angle LOOKS bigger than it ' +
        'is from behind the cue ball.',
  ...
  // ============================================================
  {
    ...
    description:
      ...
      'geometric line — useful when you need precision on a cut you’ve calculated carefully.',
    tips: [
  ...
  },
  {
    ...
    difficulty: 3,
    description:
      'A soft cut where the point isn’t just to pot the ball — it’s to pull the cue ball well back ' +
      'off the tangent line afterward for a better angle on the next shot. Speed control matters as much ' +
  ...
  },
  {
    ...
    description:
      ...
      'contact instead of drifting onto it gradually — the classic power-position tool for closing big ' +
      'distances down the table.',
    tips: [
  ...
  },
  {
    ...
    description:
      ...
      'is the cleanest possible demonstration of the tangent-line (90°) rule.',
    tips: [
      ...
      'This is the shot to groove until the 90° rule becomes instinctive — it underlies almost all cut-shot ' +
        'position play.',
    ],
    balls: [
  ...
  },
  {
    ...
    description:
      ...
      'forgiving than side-pocket banks because the pocket mouth is wider — a great shot for learning to ' +
      'trust the mirror system under a bit less pressure.',
    tips: [
  ...
  },
  {
    ...
    tips: [
      'Running english (spin that matches the roll direction the object ball will take off the rail) ' +
        'subtly changes throw at contact, which shortens or lengthens the resulting bank angle — a fine-' +
        'tuning tool once your basic mirror-system aim is close.',
  ...
  },
  {
    ...
    tips: [
      ...
      'This is the clearest possible proof of the 90° rule — once you can call this carom, you understand ' +
        'the tangent line at a level most players never reach.',
    ],
    balls: [
